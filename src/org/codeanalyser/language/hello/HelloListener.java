...
public interface HelloListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link HelloParser#catchClause}.
	 * @param ctx the parse tree
	 */
	void enterCatchClause(@NotNull HelloParser.CatchClauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link HelloParser#catchClause}.
	 * @param ctx the parse tree
	 */
	void exitCatchClause(@NotNull HelloParser.CatchClauseContext ctx);
